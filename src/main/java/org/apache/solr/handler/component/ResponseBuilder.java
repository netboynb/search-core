...
public class ResponseBuilder {
	...
	/** small 与 big 合并搜索的优化，它指明小的总共有多少找到的文档 */
	public int smallFound = 0;
	/** big 的 start 要向左偏移的数量 */
	public int leftFillSize = 0;
	...
	/**
	 * public static final String NUMDOCS = "nd"; public static final String DOCFREQS = "tdf";
	 * public static final String TERMS = "terms"; public static final String EXTRACT_QUERY_TERMS =
	 * "eqt"; public static final String LOCAL_SHARD = "local"; public static final String DOC_QUERY
	 * = "dq"; *
	 */
	...
	public SolrDocumentList _responseDocs;
	public NamedList<ArrayList<Object>> _sortValues;
	...
	/**
	 * Creates a SolrIndexSearcher.QueryCommand from this ResponseBuilder. TimeAllowed is left
	 * unset.
	 */
