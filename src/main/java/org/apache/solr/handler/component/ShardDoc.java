...
public class ShardDoc extends FieldDoc {
	...
	public boolean equals(Object o) {
		...
		if(id != null ? !id.equals(shardDoc.id) : shardDoc.id != null)
			return false;
	...
	public String toString() {
		return "id=" + id + " ,score=" + score + " ,shard=" + shard + " ,orderInShard=" + orderInShard + " ,positionInResponse=" + positionInResponse + " ,sortFieldValues=" + sortFieldValues;
	}
}
